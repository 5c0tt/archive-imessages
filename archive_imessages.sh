...
#Archive is stored at /Users/$USER/Library/Messages/Scripts\ and\ Archives/archived_files
...
if [ ! -f "/Users/$USER/Library/Messages/Scripts\ and\ Archives/timestamp" ]; then
	echo "     -Timestamp file DOES NOT EXIST"
	find /Users/$USER/Library/Messages/Attachments -not -name ".DS_Store" -name "*" -type f -exec cp {} /Users/$USER/Library/Messages/Scripts\ and\ Archives/archived_files \;
else
	echo "     -TIMESTAMP file EXISTS"
	find /Users/$USER/Library/Messages/Attachments -not -name ".DS_Store" -not -name "timestamp" -name "*" -type f -newer /Users/$USER/Library/Messages/Scripts\ and\ Archives/timestamp -exec cp {} /Users/$USER/Library/Messages/Scripts\ and\ Archives/archived_files \;
fi

# Update the timestamp
echo -e "4) Update the timestamp for the next run\n"
touch /Users/$USER/Library/Messages/Scripts\ and\ Archives/timestamp
